...
save(model_file, file = "Robjects/models/model_xgboost_init.Rdata")
...
save(model_file, file = "Robjects/models/model_xgboost.Rdata")
...
save(model_file, file = "Robjects/models/model_xgboost_us_init.Rdata")
...
save(model_file, file = "Robjects/models/model_xgboost_us.Rdata")
...
save(model_file, file = "Robjects/models/model_xgboost_sparse_init.Rdata")
...
save(model_file, file = "Robjects/models/model_xgboost_sparse.Rdata")
